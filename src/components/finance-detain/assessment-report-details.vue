  ...
  <section class="component assessment-feport-details">
    ...
    <i-card title="车辆信息" style="margin-bottom:20px;">
      <data-grid :labelWidth="120" labelAlign="right" contentAlign="left">
        ...
        <data-grid-item label="初次登记日期" :span="6">{{assessmentReportInfo.registerTime | dateFormat}}</data-grid-item>
        ...
        <data-grid-item label="出厂日期" :span="6">{{assessmentReportInfo.factoryTime | dateFormat}}</data-grid-item>
